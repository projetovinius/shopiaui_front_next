        ...
        <div className="product-details-container w-screen mx-auto ">
          ...
          <div className="top-section flex flex-col lg:flex-row">
            ...
            <div className="product-info w-full lg:w-1/2 lg:pl-8">
              ...
              <p className="text-gray-500 mb-4">Categoria: {product?.category_id}</p>
              <p className="text-xl font-semibold text-sky-950 mb-4">R${product?.price}</p>
          ...
          <div className="middle-section mt-8">
            <div className="flex items-center space-x-4">
              ...
              />
              <button className="bg-sky-950 text-white px-6 py-2 rounded-lg">Adicionar ao carrinho</button>
            </div>
          </div>    
      </div>
    )
